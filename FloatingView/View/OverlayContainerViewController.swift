...
class OverlayContainerViewController: UIViewController, OverlayViewControllerDelegate {
    ...
    private func setUpController() {
        ...
        translatedView.pinToSuperviewByEdges(with: .zero, edges: [.left, .right, .bottom])
        translatedViewHeightContraint.isActive = true
        addChildByEdges(overlayViewController, in: translatedView, edges: [.right, .left, .top])
        ...
        overlayViewController.bottomSheetView.tableView.backgroundColor = .red
